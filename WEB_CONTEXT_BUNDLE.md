...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-412-erd-s-problem-412-98ca7b9f-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-412"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-412-erd-s-problem-412-98ca7b9f-v1",
      "problem_contract_sha256": "770fa6d8bc9fded986b9718a7ebc92b17caad09ba3859bbbbd446dda93b10415",
      "problem_id": "problem:um-ep-412-erd-s-problem-412-98ca7b9f",
      "route_id": "route:um-ep-412-erd-s-problem-412-98ca7b9f-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-412-erd-s-problem-412-98ca7b9f-source-fidelity-01",
      "graph_id": "graph:um-ep-412-erd-s-problem-412-98ca7b9f-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-412-erd-s-problem-412-98ca7b9f-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-412-erd-s-problem-412-98ca7b9f-root",
          "statement": {
          ...
          "statement_sha256": "7b2ed3b72241771ad416551f7832fbde0003ba8e0032b14258b03eaf8cc68c12"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-412-erd-s-problem-412-98ca7b9f-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-412-erd-s-problem-412-98ca7b9f-root",
      "route_id": "route:um-ep-412-erd-s-problem-412-98ca7b9f-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-412-fcc6ef272f23",
        "url": "https://www.unsolvedmath.com/problems/EP-412"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
